const Segments = (props) => {
  const { handleSegmentsFilter,
    segmentCheckboxes,
    setSegmentCheckboxes} = props
  
  return (
    <div>
      <h3 className='ml-4 mt-3 font-semibold'>Segments</h3>

      {Array.isArray(segmentCheckboxes) && segmentCheckboxes.map((checkbox) => (
          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div>
              <input
                ...
                onChange={() => handleSegmentsFilter(checkbox.id, checkbox.checked)}
