import './DetailedRoadReport.css'; // Ensure your CSS file is correctly imported
...
export default function DataThree({ detailOfRoad, detailChainage }) {
	const tableStyle = {
											...
											(road, index) => (
												<tr key={index}>
													...
													<td
														...
														{capitalizeFirstLetter(road?.Category)}
													</td>
													<td style={thTdStyle}>
														{road?.Remarks}
													</td>
